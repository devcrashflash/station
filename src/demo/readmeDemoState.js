...
export function createReadmeDemoState(day = new Date()) {
  ...
  return {
    ...
    readmeDemoExternalDetails: {
      "launchpad-labs/orbit#507": {
        externalTitle: "Guard checkout transitions and preserve progress",
        externalBody: "## Summary\n\nPrevents duplicate checkout submissions and keeps completed steps visible when validation sends the customer back.\n\n## Test plan\n\n- Complete checkout with keyboard navigation\n- Trigger an invalid payment response\n- Confirm completed steps remain visible",
        externalState: "open",
        fetchedAt: at(day, 11, 29),
        labels: [
          { name: "checkout", color: "#7c3aed" },
          { name: "ready for review", color: "#0e8a16" },
        ],
        files: [
          { id: "file_checkout", name: "src/checkout/CheckoutFlow.jsx", url: "https://github.com/launchpad-labs/orbit/blob/demo/src/checkout/CheckoutFlow.jsx", status: "modified", additions: 34, deletions: 9 },
          { id: "file_tests", name: "src/checkout/CheckoutFlow.test.jsx", url: "https://github.com/launchpad-labs/orbit/blob/demo/src/checkout/CheckoutFlow.test.jsx", status: "modified", additions: 28, deletions: 2 },
        ],
        comments: [
          { id: "comment_507_1", kind: "review", author: "Maya Chen", body: "The keyboard flow looks solid. Please keep the completed-step state when payment validation fails.", createdAt: at(day, 11, 18), updatedAt: at(day, 11, 18), url: "https://github.com/launchpad-labs/orbit/pull/507#pullrequestreview-demo" },
          { id: "comment_507_2", kind: "inline", author: "Jordan Lee", body: "Could we cover the retry path with a regression test before launch?", createdAt: at(day, 11, 22), updatedAt: at(day, 11, 22), url: "https://github.com/launchpad-labs/orbit/pull/507#discussion-demo", codeContext: { path: "src/checkout/CheckoutFlow.jsx", newLine: 42, lines: [{ oldLine: 38, newLine: 42, kind: "addition", content: "setCompletedSteps(nextCompletedSteps);", highlighted: true }] } },
        ],
      },
    },
    pullRequests: [],
    reviewCommentDrafts: [],
    aiPrompts: [
      { id: "prompt_review", name: "Implement with Codex", agentType: "codex", agentOrigin: "cli", icon: "sparkles", promptText: "Implement this task with the smallest safe change. Inspect the current behavior, preserve accessibility, run the relevant tests, and summarize what changed." },
    ...
    aiSessionSettings: {
      ...
      doneStateDurationSeconds: 10800,
    },
    readmeDemoAiSessions: [
      {
        id: "session_launch_review",
        provider: "codex",
        origin: "desktop",
        title: "Review launch checkout flow",
        cwd: "/Users/demo/Projects/orbit",
        state: "waiting",
        updatedAt: at(day, 11, 27),
        openTargets: ["desktop"],
        children: [
          {
            id: "session_launch_review_tests",
            provider: "codex",
            origin: "desktop",
            title: "Verify checkout tests",
            cwd: "/Users/demo/Projects/orbit",
            state: "done",
            updatedAt: at(day, 11, 24),
            completedAt: at(day, 11, 24),
            openTargets: ["desktop"],
            children: [],
          },
        ],
      ...
      {
        id: "session_release_notes",
        provider: "claude",
        origin: "cli",
        title: "Draft launch-day release notes",
        cwd: "/Users/demo/Projects/orbit",
        state: "running",
        updatedAt: at(day, 11, 23),
        openTargets: ["terminal"],
        children: [],
      },
      {
        id: "session_latency_dashboard",
        provider: "codex",
        origin: "cli",
        title: "Plan latency budget dashboard",
        cwd: "/Users/demo/Projects/console",
        state: "done",
        updatedAt: at(day, 11, 8),
        completedAt: at(day, 11, 8),
        openTargets: ["terminal"],
        children: [],
      },
    ],
